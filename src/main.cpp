...
const string strMessageMagic = "Nearkitai Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    if (nHeight == 1) {
        nSubsidy = 210000 * COIN; // premine
    }
    else if (nHeight > 1 && nHeight <= 720) {
        nSubsidy = 1 * COIN; // instamine prevention
    }   
    else if (nHeight > 720 && nHeight <= 1440) {
        nSubsidy = 4 * COIN; // instamine prevention
    }   
    else if (nHeight > 1440 && nHeight <= 2160) {
        nSubsidy = 6 * COIN; // instamine prevention
    }  
    else if (nHeight > 2160 && nHeight <= 2880) {
        nSubsidy = 8 * COIN; // instamine prevention
    }       
    else if (nHeight > 2880 && nHeight <= 46800) {
        nSubsidy = 10 * COIN; // 
    }
    else if (nHeight > 46800 && nHeight <= 90000) {
        nSubsidy = 9 * COIN; // 
    }   
    else if (nHeight > 90000 && nHeight <= 133200) {
        nSubsidy = 8 * COIN; // 
    }   	
    else if (nHeight > 133200 && nHeight <= 176400) {
        nSubsidy = 7 * COIN; // 
    }
    else if (nHeight > 176400 && nHeight <= 219600) {
        nSubsidy = 6 * COIN; // 
    }
    else if (nHeight > 219600) {
        nSubsidy = 5 * COIN; //
    }	
    // add fees.
...

{
    ...
    else if (pindexBest->nHeight+1 > 284400 && pindexBest->nHeight+1 <= 306000) {         
        nSubsidy = 18 * COIN;
    }
    else if (pindexBest->nHeight+1 > 306000 && pindexBest->nHeight+1 <= 327600) {      
        nSubsidy = 16 * COIN;
    }
    else if (pindexBest->nHeight+1 > 327600 && pindexBest->nHeight+1 <= 349200) {         
        nSubsidy = 14 * COIN;
    }
    else if (pindexBest->nHeight+1 > 349200 && pindexBest->nHeight+1 <= 370800) {      
        nSubsidy = 12 * COIN;
    }
    else if (pindexBest->nHeight+1 > 370800 && pindexBest->nHeight+1 <= 392400) {      
        nSubsidy = 10 * COIN;
    }
    else if (pindexBest->nHeight+1 > 392400 && pindexBest->nHeight+1 <= 414000) {        
        nSubsidy = 8 * COIN;
    }
    else if (pindexBest->nHeight+1 > 414000 && pindexBest->nHeight+1 <= 435600) {      
        nSubsidy = 6 * COIN;
    }
    else if (pindexBest->nHeight+1 > 435600) {                                         
        nSubsidy = 5 * COIN;
    }
...
{
    RenameThread("nearkitai-loadblk");
