...
{
    resize(900, 520);
    setWindowTitle(tr("Nearkitai") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
#endif
    setObjectName("nearkitai");
    setStyleSheet("#nearkitai { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #dedede, stop: 1 #efefef);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
    ...
    statusBar()->setStyleSheet("#statusBar { color: #ffffff; background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 0.6, stop: 0 #101010, stop: 1 #333232);  }");
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Nearkitai address"));
   ...
   // connect(TradingAction, SIGNAL(triggered()), this, SLOT(gotoTradingPage()));
    ...
    aboutAction = new QAction(QIcon(":/icons/about"), tr("&About Nearkitai"), this);
    aboutAction->setToolTip(tr("Show information about Nearkitai"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Nearkitai"));
...
void BitcoinGUI::createToolBars()
{
    ...
    toolbar->setStyleSheet("QToolButton { color: #070707; font-size: 13px; font-weight: 400; font-family: 'Verdana'; padding: 5px; padding-left: 8px; border: none; }"
		"QToolButton:hover { background-color: #dfe2e2; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #a3107e; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #c10091; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"#tabs { color: #000000; background-color: #9e9e9d; border: none; padding-top: 0px; padding-bottom: 0px; }");
   ...
   // toolbar->addAction(TradingAction);
    ...
    netLabel->setStyleSheet("#netLabel { color: #E1FFFC; }");
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Nearkitai client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Nearkitai client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Nearkitai network", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Nearkitai address or malformed URI parameters."));
    }
