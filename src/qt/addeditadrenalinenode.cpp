    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    ui->txhashLineEdit->setPlaceholderText("Enter your 3000 NEAR TXID");
    ui->outputindexLineEdit->setPlaceholderText("Enter your transaction output index");
    ui->donationaddressLineEdit->setPlaceholderText("Enter aNEARaddress for your MN donation");
...
void AddEditAdrenalineNode::on_okButton_clicked()
{
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter an ip address and port. (68.183.188.139:12041)");
        msg.exec();
        return;
    }
    ...
    {
        QMessageBox msg;
        msg.setText("Please enter the transaction hash for the transaction that has 1 3000 coins");
        msg.exec();
        return;
    }
