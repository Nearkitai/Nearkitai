...
If you want to build Nearkitai-Qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a nearkitai-qt executable will be
built by default.
...
# Pick some path to install BDB to, here we create a directory within the nearkitai directory
BDB_PREFIX="${NEARKITAI_ROOT}/db4"
mkdir -p $BDB_PREFIX
...
# Configure Nearkitai Core to use our own-built instance of BDB
cd $NEARKITAI_ROOT
./autogen.sh
...
2) The release is built with GCC and then "strip nearkitaid" to strip the debug
symbols, which reduces the executable size by about 90%.


To Build Nearkitaid with compile script
---------------------
...
Security
---------------------
To help make your nearkitai installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, nearkitai should be built with a non-executable stack
